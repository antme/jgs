...
public class PermissionConstants {
	...
	public static final String ADM_ORDER_NOTICE_MANAGE = "adm_order_notice_manage";

	public static final String ADM_ORDER_MANAGE = "adm_order_manage";
	public static final String ADM_ORDER_QUERY = "adm_order_query";
	

	public static final String ADM_USER_MANAGE = "adm_user_manage";

	public static final String ADM_USER_APPROVE = "adm_user_approve";
