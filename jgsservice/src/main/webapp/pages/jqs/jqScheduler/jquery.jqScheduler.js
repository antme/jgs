...
var defaults = {
	...
	// time formats
	titleFormat: {
		year:'yyyy年', // add by Kebin ---> 1
		month: 'yyyy年 MMMM',
		week: "yyyy年 MMM d号{ '&#8212;'[ MMM] d号 }",
		day: 'yyyy年, MMM d号, dddd'
	},
	columnFormat: {
	...
	dayNamesShortest: ['日','一','二','三','四','五','六'],	//add by Kebin --> 3
	buttonText: {
		prev: '&nbsp;&#9668;&nbsp;',
		next: '&nbsp;&#9658;&nbsp;',
		prevYear: '&nbsp;&lt;&lt;&nbsp;',
...
var dateFormatters = {
	...
	tt	: function(d)	{ return d.getHours() < 12 ? '点' : '点' },
	T	: function(d)	{ return d.getHours() < 12 ? 'A' : 'P' },
	...
	function buildSkeleton() {
		...
		for (i=0; d < maxd; i++) {
			...
			s +=
				...
				((!slotNormal || !minutes) ? d.getHours() +'点' : '&nbsp;') +
				"</th>" +
...
{	 
	...
	*/
	...
	eventEditDialog : function(event, jsEvent, view  )
	{
		...
		if(event._id && event._id.length!=36){
			buttons = {};
		}
