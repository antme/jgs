...
},beforePageText:"页",afterPageText:"共 {pages}",displayMsg:"显示 {from} 到  {to} 总共 {total} 条",nav:{first:{iconCls:"pagination-first",handler:function(){
...
_235.shadow.css({display:"none",height:"auto"});
}
...
rr.each(function(){
var f=$(this);
//FIXME 此处加$.isArray(val)判断，解决radio赋值问题，升级easyui时候请也修改升级的版本
...
$.fn.calendar.defaults={width:180,height:180,fit:false,border:true,firstDay:0,weeks:["日","一","二","三","四","五","六"],months:["一月","二月","三月","四月","五月","六月","7月","8月","9月","10月","11月","12月"],year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date(),onSelect:function(date){
}};
})(jQuery);
(function($){
function init(_46f){
...
$("<div  class=\"datagrid-header-check\"></div>").html("<div style=\"font-size:12px;\"><input  type=\"checkbox\"/><span>全选</span></div>").appendTo(td);
