...
public class QuartzHandler {
	...
	private static Logger logger = LogManager.getLogger(QuartzHandler.class);
...
//    private ApplicationContext context;  
    ...
    public QuartzHandler(ServletContext servletContext) {  
    	wac =    WebApplicationContextUtils.getRequiredWebApplicationContext(servletContext);
        scheduler = (StdScheduler) wac.getBean("schedulerFactory");
    }  
    ...
    public static boolean enableCronSchedule(CustomJob schedulingJob, JobDataMap paramsMap, boolean isStateFull) {
        ...
        try {  
            ...
            e.printStackTrace(); 
            logger.error("*** Exception when add a schedule ***"); 
            return false;  
        }  
        return true;  
    }  
