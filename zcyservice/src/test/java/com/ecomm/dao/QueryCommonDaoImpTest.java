...
public class QueryCommonDaoImpTest extends BaseTestCase {
	...
	public void testUpdateById() {
		...
		TestTable tb = (com.zcyservice.bean.mock.TestTable) dao.findOneByQuery(builder, TestTable.class);
		assertNotNull(tb);
		...
		tb = (com.zcyservice.bean.mock.TestTable) dao.findOneByQuery(builder, TestTable.class);
		assertNotNull(tb);
